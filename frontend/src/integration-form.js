...
export const IntegrationForm = () => {
    ...
    const handleIntegrationChange = (event, value) => {
        ...
        console.log('Autocomplete changed from', currType, 'to', value);
        // Reset the integration parameters when changing integration type
    ...
    return (
        <Box display='flex' justifyContent='center' alignItems='center' flexDirection='column' sx={{ width: '100%' }}>
            ...
            <Autocomplete
                ...
                onChange={(event,value) => handleIntegrationChange(event,value)}
            />
            </Box>
            {currType && 
            <Box>
